        ...
        <div className="max-w-[1140px] mx-auto">
          ...
          <div className="w-full flex flex-wrap">
            ...
            <div className="bg-[#090909] w-[367px] flex text-center items-center p-[15px] min-h-60 mr-[2px] mb-[2px] overflow-hidden">
                <img 
                className="max-w-[180px] m-auto h-auto"
                src="src\assets\Dream-Nice-300x300.png" alt="" />
            </div>
            ...
            <div className="bg-[#090909] w-[367px] flex text-center items-center p-[15px] min-h-60 mr-[2px] mb-[2px] overflow-hidden">
                <img 
                className="max-w-[180px] m-auto h-auto"
                src="src\assets\samarth-300x300.png" alt="" />
            </div>
            ...
            <div className="bg-[#090909] w-[367px] flex text-center items-center p-[15px] min-h-60 mr-[2px] mb-[2px] overflow-hidden">
                <img 
                className="max-w-[180px] m-auto h-auto"
                src="src\assets\global-exporter-300x300.png" alt="" />
            </div>
            ...
            <div className="bg-[#090909] w-[367px] flex text-center items-center p-[15px] min-h-60 mr-[2px] mb-[2px] overflow-hidden">
                <img 
                className="max-w-[180px] m-auto h-auto"
                src="src\assets\Peakenza-300x300.png" alt="" />
            </div>
            ...
            <div className="bg-[#090909] w-[367px] flex text-center items-center p-[15px] min-h-60 mr-[2px] mb-[2px] overflow-hidden">
                <img 
                className="max-w-[180px] m-auto h-auto"
                src="src\assets\MK-Plastics-300x300.png" alt="" />
            </div>
            <div className="bg-[#090909] w-[367px] flex text-center items-center p-[15px] min-h-60 mr-[2px] mb-[2px] overflow-hidden">
                <img 
                className="max-w-[180px] m-auto h-auto"
                src="src\assets\JB-Associates-300x300.png" alt="" />
            </div>
            <div className="bg-[#090909] w-[367px] flex text-center items-center p-[15px] min-h-60 mr-[2px] mb-[2px] overflow-hidden">
                <img 
                className="max-w-[180px] m-auto h-auto"
                src="src\assets\Kamal-Jain-300x300.png" alt="" />
            </div>
            <div className="bg-[#090909] w-[367px] flex text-center items-center p-[15px] min-h-60 mr-[2px] mb-[2px] overflow-hidden">
                <img 
                className="max-w-[180px] m-auto h-auto"
                src="src\assets\ghar-pe-tailor-300x300.png" alt="" />
            </div>
