...
import img1 from "../../assets/Dream-Nice-300x300.png"
          ...
          <div className="w-full flex flex-wrap">
            <div className="bg-[#090909] w-[367px] flex text-center items-center p-[15px] min-h-60 mr-[2px] mb-[2px] overflow-hidden">
              <img
                ...
                alt=""
              />
              <div className=" relative h-[100%] left-[-282px] top-[5px] ">
                <div className="rounded-tr-[20px] bg-black bottom-0 inline-block h-[30px] w-[30px] -left-[131%] top-[91%] relative">
                  <div className="text-[10px] relative top-[23%] cursor-pointer">
                    <FontAwesomeIcon
